...
from prismatic.vla.datasets.rlds import make_interleaved_dataset, make_single_dataset, return_rlds_dataset
...
class RLDSDataset(IterableDataset):
    ...
    # def make_dataset_from_rlds(self, rlds_config):
    #     return return_rlds_dataset(**rlds_config)
